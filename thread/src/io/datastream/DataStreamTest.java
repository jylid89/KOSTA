		...
		public void actionPerformed( ActionEvent ev ){
			...
			else if ( evtBtn == bLoad )
			{
				...
				DataInputStream dis = new DataInputStream(new FileInputStream("data.txt"));
					...
					tfAge.setText(Integer.toString(dis.readInt()));
					tfHeight.setText(Double.toString(dis.readDouble()));
					tfBloodType.setText(Character.toString(dis.readChar()));
