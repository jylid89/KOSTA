	...
	class EventHandler implements ActionListener{
		public void actionPerformed(ActionEvent ev){
				...
				*/
				...
				try{
					ObjectOutputStream out = new ObjectOutputStream(
						new FileOutputStream("src\\data9.txt"));
			...
			// "읽어오기" 버튼이 눌렸을 
				...
				try{
				ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src\\data9.txt"));			//출력 통로(stream)
				Record rec = (Record)ois.readObject();
